...
class _UserDetailsPageState extends State<UserDetailsPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Gradient color animation for background
    _gradientStartColor = ColorTween(
      begin: Colors.deepPurple.shade700,
      end: Colors.cyan.shade600,
              ...
              return Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      _gradientStartColor.value ?? Colors.deepPurple.shade700,
                      _gradientEndColor.value ?? Colors.indigo.shade900,
                    ],
                  ),
                ),
                child: Stack(
                  children: [
                    ...
                    Positioned.fill(
                      child: Opacity(
                        opacity: 0.1,
                        child: Image.asset(
                          'assets/pattern.png', // Replace with your pattern asset or use a package like flutter_svg
